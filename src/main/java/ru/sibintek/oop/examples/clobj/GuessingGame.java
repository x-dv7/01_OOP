...
class Game {
	...
	public void startGame() {
		...
		// Three player objects are created and assign them to the three Player instance
		// variables
		p1 = new Player();
		p2 = new Player();
		p3 = new Player();
		...
		while (true) {
			...
			// get each player's guess() method result by accessing number variable of each
			// player
			guessp1 = p1.number;
