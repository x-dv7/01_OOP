...
//Существует три вида инициализаторов:
//Инициализирующие выражения - при объявлении переменных
//Статические блоки инициализации - при первом обращении к классу
//Нестатические блоки инициализации - перед логикой конструктора
class Blocks{
